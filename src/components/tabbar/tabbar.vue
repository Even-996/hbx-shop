    ...
    <el-row>
      <div class="herder_content">
        <div class="all_goods_show" style="padding-left: 10px; display: flex; align-items: center">
          ...
          <ul class="hidden-xs-only " v-for="(item, index) in arr1" :key="index">
            ...
            <ul class="show_choose_goods" :class={index} v-show="ishow == index&&index!=4" @mouseover="showGoods(index)"
        ...
        <div class="title_hbx">
          <router-link to="/home"><img
              src="https://static.hbx.com/bundles/hypebeastweb/images/hbx-logo.svg?1603102056"/></router-link>
        </div>
        <div>
          <ul>
            ...
            <li class="hidden-xs-only img_cna" @mouseover="iscnyShow=true" @mouseleave="iscnyShow=false">
              <router-link to="/bags"><img
                  src="https://static.hbx.com/bundles/hypebeastweb/images/flags/cn.jpg?1603090404"/>CNY
              </router-link>
      ...
      <el-drawer title="我是标题" :visible.sync="drawer" :with-header="false" append-to-body direction="ltr" size="70%">
        ...
        <div class="drop_clothse">
          <ul>
            <router-link to="/man">
              <li :class="isactived==1?'isactive':''" @click="changeActive(1)">男装<i
                  class="el-icon-arrow-right drop_clothse_right"></i></li>
            </router-link>
            <router-link to="/women">
              <li :class="isactived==2?'isactive':''" @click="changeActive(2)">女装<i
                  class="el-icon-arrow-right drop_clothse_right"></i></li>
            </router-link>
            <router-link to="/kid">
              <li :class="isactived==3?'isactive':''" @click="changeActive(3)">童装<i
                  class="el-icon-arrow-right drop_clothse_right"></i></li>
            </router-link>
          </ul>
        </div>
        <div class="drop_other_goods">
          <ul>
            <router-link to="/times">
              <li :class="isactived==4?'isactive':''" @click="changeActive(4)">中古逸品</li>
            </router-link>
            <router-link to="/newest">
              <li :class="isactived==5?'isactive':''" @click="changeActive(5)">最新发售</li>
            </router-link>
            <router-link to="/discount">
              <li :class="isactived==6?'isactive':''" @click="changeActive(6)">折扣商品</li>
            </router-link>
            <li>HBX手机APP</li>
            <li>登入</li>
            <li>帮助</li>
